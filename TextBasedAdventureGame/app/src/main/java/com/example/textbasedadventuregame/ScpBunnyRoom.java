...
public class ScpBunnyRoom extends AppCompatActivity {
    public static AppDatabase DBINSTANCE;

    public void onNextScpBunnyButtonClick(View view) {
        RadioGroup group = (RadioGroup) findViewById(R.id.scp_bunny_option_group);
        ...
        if (checkedButtonId == -1) {
            ...
            if (position == 0) {
                // They chose to examine the bunny
                TextView text = (TextView) findViewById(R.id.additional_scp_bunny_text);
                text.setText("bunny description");
            } else if (position == 1) {
                // They chose to pet the bunny
                TextView text = (TextView) findViewById(R.id.additional_scp_bunny_text);
                text.setText("appreciative bunny");
            }  else if (position == 2) {
                // They chose to ask the bunny what it is doing here
                TextView text = (TextView) findViewById(R.id.additional_scp_bunny_text);
                text.setText("bunny talks about its backstory");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scp_bunny_room);

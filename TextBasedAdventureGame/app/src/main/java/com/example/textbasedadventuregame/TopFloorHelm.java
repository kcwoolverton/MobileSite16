...
public class TopFloorHelm extends AppCompatActivity {
    public static AppDatabase DBINSTANCE;

    public void onNextHelmButtonClick(View view) {
        ...
        TextView text = (TextView) findViewById(R.id.additional_helm_text);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_top_floor_helm);
    }
}
